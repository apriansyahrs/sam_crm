...
class PlanVisitPolicy
{
    ...
    {
        return $user->can('view_any_plan::visit');
    }
    ...
    {
        return $user->can('view_plan::visit');
    }
    ...
    {
        return $user->can('create_plan::visit');
    }
    ...
    {
        return $user->can('update_plan::visit');
    }
    ...
    {
        return $user->can('delete_plan::visit');
    }
    ...
    {
        return $user->can('delete_any_plan::visit');
    }
     ...
     */
    public function replicate(User $user, PlanVisit $planVisit): bool
    {
